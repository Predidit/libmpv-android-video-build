...
# ffmpeg
[ ! -d ffmpeg ] && git clone --depth 1 --branch n$v_ffmpeg https://github.com/FFmpeg/FFmpeg.git ffmpeg && cd ffmpeg && git reset --hard 09dc319bf3de78803f7f6a637e2cafdc441499e5 && cd ..
